"use strict";
const h = require("socket.io-client"),
  c = require("eventemitter3"),
  d = ({ id: a }) => {
    document.getElementById(`vid_${a}`)?.remove();
  },
  m = { transports: ["polling", "websocket"] },
  l = { log: !0, warn: !0, error: !0 };
class _ extends c {
  constructor({ path: t, ioOptions: i, iceConfig: r, logging: o = l }) {
    super(),
      (this._peers = {}),
      (this._socketEvents = {
        log: (e) => {
        ...
        message: (e) => {
          ...
          if (
            this._peers[s] &&
            this._peers[s].connectionState === "connected"
          ) {
          ...
          switch (e.type) {
            case "stream-ready":
              ...
              return;
            case "offer":
              this._peers[s] || this._connectPeer(s),
            ...
            case "candidate":
              ...
              this._peers[s].addIceCandidate(n);
              return;
            default:
              return;
          }
      ...
      (this._rtcEvents = {
        makeOffer: (e) => {
          this.log("Making offer:", { peer: this._peers[e] }),
            this._peers[e]
              .createOffer()
              .then(
        ...
        makeAnswer: (e) => {
          this.log("Sending answer:", { peer: this._peers[e] }),
            this._peers[e]
              .createAnswer()
              .then(
                this._rtcEvents.sendLocalDescription.bind(this, e),
        ...
        sendLocalDescription: async (e, s) => {
          try {
            await this._peers[e].setLocalDescription(s),
              this._sendMessage({
                toId: e,
                name: this.user.name,
                room: this.room,
            ...
            this._peers[e].connectionState !== "new" &&
        ...
        addTrack: (e, s) => {
          this.log("Remote stream added for ", this._peers[e]),
            this._streams[e]?.id !== s.streams[0].id &&
              ((this._streams[e] = s.streams[0]),
              this.emit("stream", { id: e, stream: s.streams[0] }),
              this.socket.emit("stream", { id: e, stream: s.streams[0] }));
        },
        removeTrack: (e, s) => {
          (this.isOriginator = !1),
            this._removePeer(e),
            this.emit("left", { id: e, stream: s.streams[0] });
        },
        iceCandidate: (e, s) => {
          s.candidate &&
            this._sendMessage({
        ...
        stateChange: (e, s) => {
          const n = this._peers[e].connectionState;
      ...
      (this.warn = o.warn ? console.warn : () => {}),
      (this.error = o.error ? console.error : () => {}),
      (this.socket = h(t, { ...m, ...i })),
      (this.iceConfig = r),
      (this._streams = {}),
      (this.user = {}),
  ...
  setup({ name: t, gridId: i }) {
    ...
    try {
      ...
      console.error("setup failed.", o.message);
    }
  }
  async getMyStream() {
    if (!this.isSetup)
    ...
    return navigator.mediaDevices
      ...
      .then((t) => (this.log("Media stream ready."), (this._localStream = t)));
  }
  startListeners() {
  ...
  async _createPeer(t) {
    try {
      ...
      (this._peers[t] = new RTCPeerConnection(this.iceConfig)),
        (this._peers[t].onicecandidate = this._rtcEvents.iceCandidate.bind(
          this,
          t
        )),
        (this._peers[t].ontrack = this._rtcEvents.addTrack.bind(this, t)),
        (this._peers[t].onremovetrack = this._rtcEvents.removeTrack.bind(
          this,
          t
        )),
        (this._peers[t].onconnectionstatechange =
          this._rtcEvents.stateChange.bind(this, t)),
        this.log("Created RTC Peer for:", { socketId: t, peers: this._peers });
    } catch (i) {
  ...
  _connectPeer(t) {
    if (!t) throw new Error("_connectPeer requires socket id.");
    ...
    this._createPeer(t),
      this._peers[t].addStream(this._localStream),
      this.isOriginator
    ...
    if (!t)
      this._peers.forEach((i, r) => {
        this.log("Closing peer connection:", { id: t, peer: i }),
          i.close(),
          delete this._peers[r];
      }),
        (this._streams = {});
    else {
      if (!this._peers[t]) return;
