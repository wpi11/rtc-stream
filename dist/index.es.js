...
class f extends c {
  constructor({
    ...
    super(), this._peers = {}, this._socketEvents = {
      ...
      connect: () => (this.log("client > websockets ready."), this.emit("connect"), this),
      created: (e) => {
      ...
      stateChange: (e, s) => {
        ...
        this.log("RTC state change:", n), (n === "disconnected" || n === "failed") && this.emit("left", {
          id: e
        });
      },
      sdpError: (e) => {
    ...
    }, this.socket = _(i), this.iceConfig = r, this._streams = {}, this.user = {}, this.isOriginator = !1, this.connectReady = !1, this.inCall = !1, this.isSetup = !1, this.log("client > rtc launched..", { path: t, ioOptions: i, iceConfig: r });
  }
  ...
  _connectPeer(t) {
    ...
    this._createPeer(t), this._peers[t].addStream(this._localStream), this.isOriginator ? (this.log("client > you are the host."), this.log("client > creating offer:", t), this._rtcEvents.makeOffer(t)) : this.log("client > you are the agent.");
  }
  _removePeer(t) {
    if (!t)
  ...
  joinRoom(t, i) {
    ...
    this.user.name = t, this.log("client > create or join", { name: this.user.name, room: i }), this.socket.emit("create or join", {
      user: this.user,
      name: this.user.name,
      room: i
    });
